...
var name =console.log(connection.query('SELECT name from entries WHERE id=1'));
var mobile =console.log(connection.query('SELECT mobile from entries WHERE id =1'));
var gender = console.log(connection.query('SELECT gender from entries WHERE id =1'));
